...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-216434.861738, 7078286.988107, -178605.048658, 7101224.464140], maxZoom: 28, minZoom: 3
    })
});
...
map.getView().fit([-216434.861738, 7078286.988107, -178605.048658, 7101224.464140], map.getSize());
